...
int al_deleteArrayList(ArrayList* pList) // Hay que eliminar la referencia a los datos del arraylist, no borrar los array list. Creo que igual funciona, pero fijate igual
{                                        // free a la lista y free al array list
    if (pList == NULL)
        return -1;
    free(pList);
    return 0;
