...
void borrarProgramador (eProgramador lista[], eCategoria cate[], eProyecto proyecto[], eProgProy tabla[], int cantProg, int id)
{
    ...
    for (int i = 0; i < cantProg; i++)
    {
        ...
        {
            printf("\n-------------------------------------------------------------------------------------------------------------\n");
            imprimirProgramador(lista,cate,proyecto, tabla, cantProg);
            printf("\n-------------------------------------------------------------------------------------------------------------\n");
